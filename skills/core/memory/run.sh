...
USAGE
  ...
  memory hint "<natural language>" [--peek]
...
EXAMPLES
  ...
  memory hint "help me debug the feishu workflow"         # with related topics
...
TIPS
  ...
  - Use 'hint' to auto-extract keywords and see related topics
