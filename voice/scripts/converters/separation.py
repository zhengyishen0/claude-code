...
SCRIPT_DIR = Path(__file__).parent; VOICE_DIR = SCRIPT_DIR.parent.parent
sys.path.insert(0, str(VOICE_DIR / "pipelines" / "python" / "separation"))

# Configuration
MODEL_NAME = "SepReformer_Base_WSJ0"
MODEL_DIR = VOICE_DIR / "pipelines" / "python" / "separation" / "models" / MODEL_NAME
WEIGHTS_PATH = MODEL_DIR / "log" / "scratch_weights" / "epoch.0180.pth"
CONFIG_PATH = MODEL_DIR / "configs.yaml"
OUTPUT_PATH = VOICE_DIR / "models" / "coreml" / "SepReformer_Base.mlpackage"
