...
/**
 * Test runner for the KMP voice pipeline
 */
fun runTests() {
...
private fun testFullPipeline() {
    ...
    val audio = AudioFileReader.readFile(TEST_AUDIO_PATH)
    if (audio == null) {
        println("FAILED - trying alternative file")
        // Try alternative
        val altAudio = AudioFileReader.readFile(ALT_TEST_AUDIO_PATH)
        if (altAudio == null) {
...
private fun testFullPipelineWithAudio(
    ...
    val vadStart = kotlin.system.getTimeMillis()
