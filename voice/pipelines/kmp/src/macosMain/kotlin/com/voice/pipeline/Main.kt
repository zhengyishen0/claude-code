...
private fun runBenchmark(audioPath: String?) {
    ...
    // Read test audio
    val testAudioPath = audioPath ?: "/Users/zhengyishen/Codes/claude-code/voice/data/recordings/recording_20260112_002226.wav"
...
private fun testCoreMLModels() {
    ...
    // Test ASR model
    val asrPath = "$MODEL_DIR/sensevoice-500-itn.mlmodelc"
    print("  ASR model: ")
    ...
    // Test speaker model
    val speakerPath = "$MODEL_DIR/xvector.mlmodelc"
    print("  Speaker model: ")
...
private fun testFullPipeline() {
    ...
    val testAudioPath = "/Users/zhengyishen/Codes/claude-code/voice/data/recordings/recording_20260112_002226.wav"
    ...
    if (audio == null) {
        ...
        // Try alternative
        val altAudio = AudioFileReader.readFile("/Users/zhengyishen/Codes/claude-code/voice/data/recordings/recording_20260111_235901.wav")
        if (altAudio == null) {
